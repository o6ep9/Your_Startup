...
function openThxPopUp() { 
  ...
  document.querySelector('.application').classList.toggle('hide') 
} 
function closeThxPopUp() { 
  document.querySelector('.application-thx').classList.toggle('called') 
  document.querySelector('.header').classList.toggle('hide') 
}
...
function burgerCall(){
  ...
  this.classList.toggle('active');
  document.querySelector('nav').classList.toggle('menu_visible');
  document.querySelector('.right-nav').classList.toggle('menu_visible');
  // проверка для корректного отображения backgroundColor у header
